  ...
  return (
    <Container>
      <Wrapper>
          ...
          <Right>
            <div>
              <a
                target="_blank"
                rel="noreferrer"
                href="https://www.facebook.com/mdsahadat.hossin.5851/"
              >
                <FaFacebook />
              </a>
            </div>
            <div>
              <a
                target="_blank"
                rel="noreferrer"
                href="https://www.linkedin.com/in/md-sahadat-hossin-427282226/"
              >
                <FaLinkedin />
              </a>
            </div>
        ...
        <CopyRight>© Md Sahadat Hossin 2022. All rights reserved</CopyRight>
      </Wrapper>
    </Container>
  );
};
